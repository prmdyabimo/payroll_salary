    ...
    <table id="datatable" class="display nowrap">
        <thead>
            <tr>
                ...
                <th>Gaji Awal</th>
                <th>Potongan</th>
                <th>Hasil Gaji Setelah Potongan</th>
            </tr>
        </thead>
        <tbody>
            <?php $no = 1; ?>
    ...
    <div data-te-modal-dialog-ref
        ...
        <div
            ...
            <div class="relative p-4">
                <form action="<?= base_url('/recap-salary-by-month'); ?>" method="post" id="formDownload">
                    <?= csrf_field(); ?>
                    <!-- MONTH -->
                    ...
                    <div class="relative mb-3" data-te-input-wrapper-init>
                        <input type="month"
                            ...
                            id="exampleFormControlInput1" placeholder="Bulan" name="month"
                            value="<?= old('month'); ?>" />
